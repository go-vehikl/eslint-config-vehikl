...
module.exports = {
  rules: {
    "no-template-curly-in-string": "error", // If it's not a template string, flag template-style code in that string
    "array-callback-return": "error", // Array.map/reduce/every/some/etc... requires return statements
