...
module.exports = {
  ...
  //   "require-await": "warn", // If you have an async function, it should have at least one await
  //   "no-shadow": "warn", // Don't have same-name variables in various levels of scope (can be misleading)
  ...
  //   "no-magic-numbers": ["warn", { "ignore": [1] }], // You must create constants to better identify numbers.  Ie `const a = test - 10` is bad because there is no context to what 10 actually means.
